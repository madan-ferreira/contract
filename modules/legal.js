...
function legalEntity() {
     ...
     switch (selectSpouse.value) {
          case "1":
               clientP = `         **${getBusinessName}**, pessoa jurídica de direito privado inscrita no CNPJ nº ${getCnpj}, com endereço na ${getBusinessStreet}, nº ${getBusinessNumber}, ${getBusinessCity}/${getBusinessState}, CEP ${getbusinessCep}, neste ato representada por ${getFranchisee}, ${nationality}, ${businesStatus}, ${carrier} do RG nº ${getRg}, ${registered} no CPF sob nº ${getCpf}, ${genderStatus} sob o regime de comunhão universal de bens com ${getSpouse}, ${spouseNation}, ${spouseCarrier} do RG nº ${getSpouseRg}, ${spouseRegistered} no CPF sob nº ${getSpouseCpf}, e-mail ${getEmail}, doravante denominado Franqueado, por outro lado, conjuntamente denominados "as Partes", assinaram o presente (doravante denominado o presente Contrato ou Contrato) nos seguintes termos:`;
               break;
          case "5":
               clientP = `         **${getBusinessName}**, pessoa jurídica de direito privado inscrita no CNPJ nº ${getCnpj}, com endereço na ${getBusinessStreet}, nº ${getBusinessNumber}, ${getBusinessCity}/${getBusinessState}, CEP ${getbusinessCep}, neste ato representada por ${getFranchisee}, ${nationality}, ${carrier} do RG nº ${getRg}, ${registered} no CPF sob nº ${getCpf}, ${genderStatus} sob o regime de comunhão universal de bens com ${getSpouse}, ${spouseNation}, ${spouseCarrier} do RG nº ${getSpouseRg}, ${spouseRegistered} no CPF sob nº ${getSpouseCpf}, e-mail ${getEmail}, doravante denominado Franqueado, por outro lado, conjuntamente denominados "as Partes", assinaram o presente (doravante denominado o presente Contrato ou Contrato) nos seguintes termos:`;
               break;
          default:
               clientP = `        **${getBusinessName}**, pessoa jurídica de direito privado inscrita no CNPJ nº ${getCnpj}, com endereço na ${getBusinessStreet}, nº ${getBusinessNumber}, ${getBusinessCity}/${getBusinessState}, CEP ${getbusinessCep}, neste ato representada por ${getFranchisee}, ${nationality}, ${carrier} do RG nº ${getRg}, ${born} em ${getBirth}, ${registered} no CPF sob nº ${getCpf}, ${genderStatus}, e-mail ${getEmail}, doravante denominado Franqueado, por outro lado, conjuntamente denominados "as Partes", assinaram o presente (doravante denominado o presente Contrato ou Contrato) nos seguintes termos:`;
               break;
     }
...
assinar este Contrato, o Franqueado confirma que leu e concorda com o conteúdo dos referidos documentos na íntegra.`,
     ...
     var body = [
          [
               ...
               `${getBusinessName} ${getRg}\nCNPJ: ${getCnpj}\nEndereço: ${getBusinessStreet}, ${getBusinessComplement}, N°${getBusinessNumber}\n${getBusinessComplement},\n${getBusinessCity} – ${getBusinessCity}, CEP: ${getbusinessCep}.\nBanco: ${getBank}\nAgência: ${getAg}\nConta: ${getCc}\nE-mail: ${getEmail}`,
          ],
     ];
